...
(function (global) {
  ...
  const STROKE = {
    ...
    // Added for the Library and Self MIDI rows, which name a kind of thing on
    // every line. Same 16-unit grid, same stroke, whole and half units only.
    note:       'M6 12.5 A2 2 0 1 0 6 8.5 A2 2 0 1 0 6 12.5 M8 11 L8 2.5 L13.5 4 L13.5 9 M13.5 9 A2 2 0 1 1 13.5 9.01',
    heart:      'M8 13.5 C8 13.5 1.5 9.5 1.5 5.9 A3.4 3.4 0 0 1 8 4.6 A3.4 3.4 0 0 1 14.5 5.9 C14.5 9.5 8 13.5 8 13.5 Z',
    clock:      'M8 1.5 A6.5 6.5 0 1 0 8 14.5 A6.5 6.5 0 1 0 8 1.5 M8 4.5 L8 8 L10.5 10',
    list:       'M5.5 4 L14 4 M5.5 8 L14 8 M5.5 12 L14 12 M2 4 L2.5 4 M2 8 L2.5 8 M2 12 L2.5 12',
    grid:       'M2 2.5 L6.5 2.5 L6.5 7 L2 7 Z M9.5 2.5 L14 2.5 L14 7 L9.5 7 Z M2 9 L6.5 9 L6.5 13.5 L2 13.5 Z M9.5 9 L14 9 L14 13.5 L9.5 13.5 Z',
    upload:     'M8 11 L8 2.5 M4.5 6 L8 2.5 L11.5 6 M2.5 13.5 L13.5 13.5',
    trash:      'M2.5 4 L13.5 4 M6.5 4 L6.5 2.5 L9.5 2.5 L9.5 4 M4 4 L4.8 13.5 L11.2 13.5 L12 4 M6.6 6.5 L6.9 11 M9.4 6.5 L9.1 11',
    pencil:     'M2.5 13.5 L2.5 11 L11 2.5 L13.5 5 L5 13.5 Z M9.5 4 L12 6.5',
    drive:      'M1.5 9.5 L14.5 9.5 L14.5 13 L1.5 13 Z M3.5 9.5 L4.5 3.5 L11.5 3.5 L12.5 9.5 M11.5 11.25 L12.5 11.25',
    tag:        'M8.5 1.5 L14.5 7.5 L8 14 L2 8 L2 1.5 Z M5 4.5 L5.1 4.5',
    wave:       'M2 8 L2 8 M4 5 L4 11 M6.5 2.5 L6.5 13.5 M9 4.5 L9 11.5 M11.5 6.5 L11.5 9.5 M14 7.5 L14 8.5',
    target:     'M8 1.5 A6.5 6.5 0 1 0 8 14.5 A6.5 6.5 0 1 0 8 1.5 M8 5 A3 3 0 1 0 8 11 A3 3 0 1 0 8 5 M8 7.6 L8 8.4',
    wrench:     'M13.5 3 L11 5.5 L10.5 5 L13 2.5 A4 4 0 0 0 8.5 7.5 L3 13 L3.5 13.5 L9 8 A4 4 0 0 0 13.5 3 Z',
  };
